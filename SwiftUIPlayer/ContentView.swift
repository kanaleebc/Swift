...
struct ContentView: View {
    ...
    var playerView: BCOVPUIPlayerView = {
        ...
        return BCOVPUIPlayerView(playbackController: nil, options: options, controlsView: controlsView)
    }()
        ...
        VStack {
            ...
            PlayerUI(playbackController: playbackController)
                ...
                .onAppear() {
                    ...
                    let configuration = [
                        kBCOVPlaybackServiceConfigurationKeyAssetID: Constants.VideoId
                    ]
                    
                    playbackService?.findVideo(withConfiguration: configuration, queryParameters: nil) { [weak playbackController] video, jsonResponse, error in
                        if let video = video {
